            ...
            header={
                <div className="flex items-center gap-4">
                    ...
                    <h2 className="text-3xl font-display font-medium text-white tracking-tight leading-tight">
                        Editar <span className="text-accent-500">Hardware</span>
                    </h2>
                </div>
            }
        >
                        ...
                        <form onSubmit={submit} className="space-y-10">
                            ...
                            <div className="grid md:grid-cols-3 gap-10">
                                ...
                                <div className="flex flex-col justify-end">
                                    <div className="flex items-center gap-4 p-4 bg-primary-950 rounded-xl border border-accent-500/20 selection:bg-accent-500/30">
                                        <input
                                            type="checkbox"
                                            id="is_quotable"
