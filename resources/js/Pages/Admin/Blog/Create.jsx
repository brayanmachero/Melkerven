        ...
        <AuthenticatedLayout user={auth.user}>
            ...
            <div className="py-12">
                <div className="max-w-4xl mx-auto sm:px-6 lg:px-8">
                    <h2 className="text-2xl font-bold text-white mb-6">Nuevo Artículo</h2>
                    <form onSubmit={handleSubmit} className="tech-card space-y-6">
                        ...
                        <div className="grid sm:grid-cols-2 gap-6">
                            ...
                            <div>
                                <label className="block text-xs font-bold uppercase tracking-widest text-primary-400 mb-2">Imagen</label>
                        ...
                        <div>
                            ...
                            <textarea value={data.excerpt} onChange={e => setData('excerpt', e.target.value)} rows={2} className="w-full bg-primary-950 border border-white/10 rounded-xl px-4 py-3 text-white focus:border-accent-500" placeholder="Resumen breve del artículo..." />
                        </div>

                        <div>
                            <label className="block text-xs font-bold uppercase tracking-widest text-primary-400 mb-2">Contenido (HTML)</label>
                            <textarea value={data.content} onChange={e => setData('content', e.target.value)} rows={12} className="w-full bg-primary-950 border border-white/10 rounded-xl px-4 py-3 text-white focus:border-accent-500 font-mono text-sm" placeholder="<p>Escribe el contenido del artículo...</p>" />
                        ...
                        <label className="flex items-center gap-3 cursor-pointer">
                            ...
                            <span className="text-sm text-white font-bold">Publicar ahora</span>
                        </label>
